...
//    	paramMap.put("jdbcPassword", "1234@Abc");
    	...
    	/****************************************表start********************************/
    	//生成包名com.company.
    	paramMap.put("packageName", "dictionarys");
    	//表名称
...
//    	/****************************************表start********************************/
//    	//生成包名com.company.
//    	paramMap.put("packageName", "one.newsarticle");
//    	//表名称
//    	paramMap.put("tableName", "news_article");
//    	//模型实体名称
//    	paramMap.put("domainObjectName", "NewsArticleTab");
//    	//模型定义
//    	paramMap.put("cnObjectName", "新闻信息");
//    	GeneratorConfiguration.generatorConfigForGen(paramMap);
//    	/****************************************表end********************************/
