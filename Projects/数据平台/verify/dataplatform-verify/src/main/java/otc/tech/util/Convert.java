...
//            longs[i] = v;
    ...
    public static void main(String[] args) {
		...
		System.out.println(o2 instanceof Long);
		System.out.println(o2 instanceof Number);
		System.out.println(o3 instanceof Long);
		System.out.println(o3 instanceof Number);
		
		System.out.println(new BigDecimal("d".trim()).longValue());
	}
