		    ...
		    var endDate = laydate.render({
		        ...
		        trigger: 'click',
		            ...
		            if (value !== '') {
		                ...
		                startDate.config.max.year = endDate.config.max.year;
		                startDate.config.max.month = endDate.config.max.month - 1;
		                startDate.config.max.date = endDate.config.max.date;
		            }
		        }
		    });
		    endDate_q = endDate;
