...
public class AgencyInfo extends BaseModel implements Serializable {
    ...
    public String toString() {
    	...
    	sb.append(StringUtils.transfDeal(projectLeader1)).append(separator);
    	...
    	sb.append(StringUtils.transfDeal(projectLeader2)).append(separator);
    	sb.append(StringUtils.decode(linefeed));
    	...
    	sb.append(StringUtils.transfDeal(projectLeader3)).append(separator);
    	sb.append(StringUtils.decode(linefeed));
    	...
    	sb.append(StringUtils.transfDeal(projectLeader4)).append(separator);
    	sb.append(StringUtils.decode(linefeed));
        if("01".equals(bondMainType)){
        	...
        	sb.append(StringUtils.transfDeal(projectLeader5)).append(separator);
        	sb.append(StringUtils.decode(linefeed));
        }
        return sb.toString();
    }
