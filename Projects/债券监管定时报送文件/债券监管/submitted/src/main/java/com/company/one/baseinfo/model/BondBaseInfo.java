...
public class BondBaseInfo extends BaseModel implements Serializable {
    ...
    public String toString() {
        ...
        sb.append(StringUtils.transfDeal(realIssueAmount)).append(separator);
        ...
        sb.append(StringUtils.transfDeal(DateUtils.dataToString(dueTime,DATE_PATTERN.YYYYMMDD))).append(separator);
