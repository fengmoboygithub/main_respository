...
public class MyStartupRunner implements CommandLineRunner {
	...
	private void firstDeal(String interfaceCode){
		...
		if("J001".equals(interfaceCode)){
	    	...
	    	OutputFileInfo outputFileInfo = new OutputFileInfo("J001", "Q");
	    	JobLogTab jobLogTab = new JobLogTab("J001", 1, outputFileInfo.getDataDate());
		...
		} else if("J002".equals(interfaceCode)){
			long start = System.currentTimeMillis();
	    	...
	    	OutputFileInfo outputFileInfo = new OutputFileInfo("J002", "Q");
	    	JobLogTab jobLogTab = new JobLogTab("J002", 1, outputFileInfo.getDataDate());
	    	...
	    	long end = System.currentTimeMillis();
	    	logger.info("数据接口名称：公司债券基本信息结束所用毫秒数为====>>>>>>"+(end-start)+"毫秒");
		} else if("J003".equals(interfaceCode)){
			long start = System.currentTimeMillis();
		...
		} else if("J004".equals(interfaceCode)){
			long start = System.currentTimeMillis();
	...
	private void repairtDeal(String interfaceCode){
		...
		if("J001".equals(interfaceCode)){
	    	...
	    	criteria1.andInterfaceCodeEqualTo("J001");
	    	...
	    	JobLogTab jobLogTab = new JobLogTab("J001", currnum, outputFileInfo.getDataDate());
	    	try {
	    	...
	    	JobLogTabExample jobLogTabExample = new JobLogTabExample();
	    	com.company.two.joblog.model.JobLogTabExample.Criteria criteria1 = jobLogTabExample.createCriteria();
	    	criteria1.andInterfaceCodeEqualTo("J002");
	    	criteria1.andInterfaceDateEqualTo(outputFileInfo.getDataDate());
	    	long count = 0;
	    	try {
				count = jobLogTabService.countByExample(jobLogTabExample);
	    	...
	    	JobLogTab jobLogTab = new JobLogTab("J002", currnum, outputFileInfo.getDataDate());
	    	try {
	    		jobLogTab.setTotalNumber((int)totalNumber);
				jobLogTabService.save(jobLogTab);
			} catch (BaseException e) {
	    	...
	    	JobLogTabExample jobLogTabExample = new JobLogTabExample();
	    	com.company.two.joblog.model.JobLogTabExample.Criteria criteria1 = jobLogTabExample.createCriteria();
	    	criteria1.andInterfaceCodeEqualTo("J003");
	    	criteria1.andInterfaceDateEqualTo(outputFileInfo.getDataDate());
	    	long count = 0;
	    	try {
				count = jobLogTabService.countByExample(jobLogTabExample);
	    	...
	    	JobLogTab jobLogTab = new JobLogTab("J003", currnum, outputFileInfo.getDataDate());
	    	try {
	    		jobLogTab.setTotalNumber((int)totalNumber);
				jobLogTabService.save(jobLogTab);
			} catch (BaseException e) {
	    	...
	    	JobLogTabExample jobLogTabExample = new JobLogTabExample();
	    	com.company.two.joblog.model.JobLogTabExample.Criteria criteria1 = jobLogTabExample.createCriteria();
	    	criteria1.andInterfaceCodeEqualTo("J004");
	    	criteria1.andInterfaceDateEqualTo(outputFileInfo.getDataDate());
	    	long count = 0;
	    	try {
				count = jobLogTabService.countByExample(jobLogTabExample);
	    	...
	    	JobLogTab jobLogTab = new JobLogTab("J004", currnum, outputFileInfo.getDataDate());
	    	try {
	    		jobLogTab.setTotalNumber((int)totalNumber);
				jobLogTabService.save(jobLogTab);
			} catch (BaseException e) {
	    	...
	    	JobLogTabExample jobLogTabExample = new JobLogTabExample();
	    	com.company.two.joblog.model.JobLogTabExample.Criteria criteria1 = jobLogTabExample.createCriteria();
	    	criteria1.andInterfaceCodeEqualTo("J005");
	    	criteria1.andInterfaceDateEqualTo(outputFileInfo.getDataDate());
	    	long count = 0;
	    	try {
				count = jobLogTabService.countByExample(jobLogTabExample);
	    	...
	    	JobLogTab jobLogTab = new JobLogTab("J005", currnum, outputFileInfo.getDataDate());
	    	try {
	    		jobLogTab.setTotalNumber((int)totalNumber);
				jobLogTabService.save(jobLogTab);
			} catch (BaseException e) {
