...
import com.interapi.app.bmp.model.RoleAuthorityRelaExample.Criteria;
...
roleName = "角色权限_页面", roleFlag = "ROLE_RoleAuthorityRela_PAGE", homePage = "/pages/RoleAuthorityRela/list.html",
...
public class RoleAuthorityRelaController {
    ...
    @Autowired
    private RoleAuthorityRelaService service;
    ...
    public ResponseDataModel<RoleAuthorityRela> get(Long id) {
        ...
        try {
            RoleAuthorityRela entity=service.getRoleAuthorityRela(id);
    ...
    public ResponseDataListModel<RoleAuthorityRela> getList(@RequestParam(required = false) String param) {
    ...
    public ResponseModel add(@RequestBody RoleAuthorityRela model) {
    ...
    public ResponseModel update(@RequestBody RoleAuthorityRela model) {
        ResponseModel responseModel = new ResponseModel();
        try {
            RoleAuthorityRela record = new RoleAuthorityRela();
            BeanUtils.copyProperties(model, record);
