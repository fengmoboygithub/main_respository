...
roleName = "菜单页面_页面", roleFlag = "ROLE_PageTab_PAGE", homePage = "/pages/PageTab/list.html",
...
public class PageTabController {
    ...
    @Autowired
    private PageTabService service;
    ...
    public ResponseDataModel<PageTab> get(Long id) {
        ...
        try {
            PageTab entity=service.getPageTab(id);
    ...
    public ResponseDataListModel<PageTab> getList(@RequestParam(required = false) String param) {
    ...
    public ResponseModel add(@RequestBody PageTab model) {
    ...
    public ResponseModel update(@RequestBody PageTab model) {
        ResponseModel responseModel = new ResponseModel();
        try {
            PageTab record = new PageTab();
            BeanUtils.copyProperties(model, record);
