...
import com.interapi.app.bmp.model.AuthorityResourceRelaExample.Criteria;
...
roleName = "权限资源_页面", roleFlag = "ROLE_AuthorityResourceRela_PAGE", homePage = "/pages/AuthorityResourceRela/list.html",
...
public class AuthorityResourceRelaController {
    ...
    @Autowired
    private AuthorityResourceRelaService service;
    ...
    public ResponseDataModel<AuthorityResourceRela> get(Long id) {
        ...
        try {
            AuthorityResourceRela entity=service.getAuthorityResourceRela(id);
    ...
    public ResponseDataListModel<AuthorityResourceRela> getList(@RequestParam(required = false) String param) {
    ...
    public ResponseModel add(@RequestBody AuthorityResourceRela model) {
    ...
    public ResponseModel update(@RequestBody AuthorityResourceRela model) {
        ResponseModel responseModel = new ResponseModel();
        try {
            AuthorityResourceRela record = new AuthorityResourceRela();
            BeanUtils.copyProperties(model, record);
