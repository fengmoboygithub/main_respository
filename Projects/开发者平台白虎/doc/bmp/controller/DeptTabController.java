...
roleName = "部门_页面", roleFlag = "ROLE_DeptTab_PAGE", homePage = "/pages/DeptTab/list.html",
...
public class DeptTabController {
    ...
    @Autowired
    private DeptTabService service;
    ...
    public ResponseDataModel<DeptTab> get(Long id) {
        ...
        try {
            DeptTab entity=service.getDeptTab(id);
    ...
    public ResponseDataListModel<DeptTab> getList(@RequestParam(required = false) String param) {
    ...
    public ResponseModel add(@RequestBody DeptTab model) {
    ...
    public ResponseModel update(@RequestBody DeptTab model) {
        ResponseModel responseModel = new ResponseModel();
        try {
            DeptTab record = new DeptTab();
            BeanUtils.copyProperties(model, record);
