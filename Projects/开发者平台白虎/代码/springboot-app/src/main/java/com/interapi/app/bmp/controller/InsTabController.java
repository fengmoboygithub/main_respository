...
public class InsTabController {
    ...
    public ResponseDataModel<InsTab> get(Long id) {
        ...
        try {
            InsTab entity=service.getInsTab(id);
    ...
    public ResponseDataPageListModel<InsTab> getListByPage(@PathVariable int currentPage, @PathVariable int itemsPerPage, @RequestParam(required = false) String param) {
        logger.info("currentPage:{},itemsPerPage:{},param:{}", currentPage, itemsPerPage, param);
        ResponseDataPageListModel<InsTab> responseModel = new ResponseDataPageListModel<InsTab>();
    ...
    @ResponseBody
    @SuppressWarnings("unchecked")
    public ResponseDataListModel<InsTab> getList(@RequestParam(required = false) String param) {
    ...
    public ResponseModel add(@RequestBody InsTab model) {
    ...
    public ResponseModel update(@RequestBody InsTab model) {
        ResponseModel responseModel = new ResponseModel();
        try {
            InsTab record = new InsTab();
            BeanUtils.copyProperties(model, record);
