package com.company.userinfo.controller;
 ...
 *
 */
@Api(value="用户数据维护",tags={"用户数据操作接口"})
...
public class UserTabController {
    ...
    public ResponseDataModel<UserTab> get(
    ...
    public ResponseDataModel<UserTab> add(@RequestBody @ApiParam(name="用户对象",value="传入json格式",required=true) UserTab model,HttpServletRequest request) {
    ...
    public ResponseDataModel<UserTab> update(@RequestBody @ApiParam(name="用户对象",value="传入json格式",required=true) UserTab model,HttpServletRequest request) {
        ResponseDataModel<UserTab> responseModel = new ResponseDataModel<UserTab>();
        Long currUserId = (Long)request.getSession().getAttribute(BaseConstant.LOGIN_KEY);
        try {
            UserTab record = new UserTab();
    ...
    public ResponseModel del(
    	@ApiParam(name="id",value="主键",required=true) Long id,HttpServletRequest request
    	) {
