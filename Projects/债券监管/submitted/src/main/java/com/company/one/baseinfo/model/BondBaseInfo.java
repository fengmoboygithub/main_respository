...
public class BondBaseInfo extends BaseModel implements Serializable {
    /**
     * 
     */
    private Integer id;
    ...
    public String toString() {
        ...
        sb.append(StringUtils.transfDeal(shortName)).append(separator);
        sb.append(StringUtils.transfDeal(bondName)).append(separator);
        sb.append(StringUtils.transfDeal(StringUtils.conversionForBondType(bondType))).append(separator);
        //sb.append(StringUtils.transfDeal(creditMeasures)).append(separator);
        //此字段暂定报送为空
        sb.append("").append(separator);
        sb.append("03").append(separator);
        sb.append(StringUtils.transfDeal(StringUtils.conversionForBillion(realIssueAmount))).append(separator);
        sb.append(StringUtils.transfDeal(StringUtils.conversionForQiXian(trem))).append(separator);
        sb.append(StringUtils.transfDeal(issueRate)).append(separator);
        sb.append(StringUtils.transfDeal(DateUtils.dataToString(issueTime,DATE_PATTERN.YYYYMMDD))).append(separator);
    ...
    public boolean equals(Object that) {
        ...
        BondBaseInfo other = (BondBaseInfo) that;
