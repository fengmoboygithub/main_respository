...
* @date 2019-09-16
*/
package com.company.one.agencyinfo.model;
...
public class AgencyInfo extends BaseModel implements Serializable {
    /**
     * 
     */
    private Integer id;
     ...
     * 
     */
    private String projectLeader1;

    /**
     * 
     */
    private String agencyType2;
     ...
     * 
     */
    private String projectLeader3;

    /**
     * 
     */
    private String agencyType4;
     ...
     * 
     */
    private String projectLeader4;

    /**
     * 
     */
    private String agencyType5;
    ...
    public String getAgencyType1() {
		return agencyType1;
	}

	public void setAgencyType1(String agencyType1) {
		this.agencyType1 = agencyType1;
	}
	...
	public String getProjectLeader1() {
		return projectLeader1;
	}

	public void setProjectLeader1(String projectLeader1) {
		this.projectLeader1 = projectLeader1;
	}

	public String getAgencyType2() {
		return agencyType2;
	}

	public void setAgencyType2(String agencyType2) {
		this.agencyType2 = agencyType2;
	}
	...
	public String getProjectLeader2() {
		return projectLeader2;
	}

	public void setProjectLeader2(String projectLeader2) {
		this.projectLeader2 = projectLeader2;
	}

	public String getAgencyType3() {
		return agencyType3;
	}

	public void setAgencyType3(String agencyType3) {
		this.agencyType3 = agencyType3;
	}
	...
	public String getProjectLeader3() {
		return projectLeader3;
	}

	public void setProjectLeader3(String projectLeader3) {
		this.projectLeader3 = projectLeader3;
	}

	public String getAgencyType4() {
		return agencyType4;
	}

	public void setAgencyType4(String agencyType4) {
		this.agencyType4 = agencyType4;
	}
	...
	public String getProjectLeader4() {
		return projectLeader4;
	}

	public void setProjectLeader4(String projectLeader4) {
		this.projectLeader4 = projectLeader4;
	}

	public String getAgencyType5() {
		return agencyType5;
	}

	public void setAgencyType5(String agencyType5) {
		this.agencyType5 = agencyType5;
	}
	...
	public String getProjectLeader5() {
		return projectLeader5;
	}

	public void setProjectLeader5(String projectLeader5) {
		this.projectLeader5 = projectLeader5;
	}
    ...
    public String toString() {
        ...
        if("01".equals(bondMainType)){
        	bondType = StringUtils.conversionForBondType(bondType);
        }
        if(!org.springframework.util.StringUtils.isEmpty(orgName1)){
        	sb.append("0114").append(separator);
        	sb.append(StringUtils.transfDeal(bondCode)).append(separator);
        	sb.append(StringUtils.transfDeal(orgName1)).append(separator);
        	sb.append(StringUtils.transfDeal(bondType)).append(separator);
        	sb.append(StringUtils.transfDeal(agencyType1)).append(separator);
        	sb.append(StringUtils.transfDeal(projectLeader1));
        	sb.append(StringUtils.decode(linefeed));
        }
        if(!org.springframework.util.StringUtils.isEmpty(orgName2)){
        	sb.append("0114").append(separator);
        	sb.append(StringUtils.transfDeal(bondCode)).append(separator);
        	sb.append(StringUtils.transfDeal(orgName2)).append(separator);
        	sb.append(StringUtils.transfDeal(bondType)).append(separator);
        	sb.append(StringUtils.transfDeal(agencyType2)).append(separator);
        	sb.append(StringUtils.transfDeal(projectLeader2));
        	sb.append(StringUtils.decode(linefeed));
        }
        if(!org.springframework.util.StringUtils.isEmpty(orgName3)){
	    	sb.append("0114").append(separator);
	        sb.append(StringUtils.transfDeal(bondCode)).append(separator);
	        sb.append(StringUtils.transfDeal(orgName3)).append(separator);
	        sb.append(StringUtils.transfDeal(bondType)).append(separator);
	    	sb.append(StringUtils.transfDeal(agencyType3)).append(separator);
	    	sb.append(StringUtils.transfDeal(projectLeader3));
	    	sb.append(StringUtils.decode(linefeed));
    	}
        if(!org.springframework.util.StringUtils.isEmpty(orgName4)){
	    	sb.append("0114").append(separator);
	        sb.append(StringUtils.transfDeal(bondCode)).append(separator);
	        sb.append(StringUtils.transfDeal(orgName4)).append(separator);
	        sb.append(StringUtils.transfDeal(bondType)).append(separator);
	    	sb.append(StringUtils.transfDeal(agencyType4)).append(separator);
	    	sb.append(StringUtils.transfDeal(projectLeader4));
	    	sb.append(StringUtils.decode(linefeed));
        }
        if("01".equals(bondMainType)){
        	if(!org.springframework.util.StringUtils.isEmpty(orgName5)){
	        	//债券
	        	sb.append("0114").append(separator);
	            sb.append(StringUtils.transfDeal(bondCode)).append(separator);
	            sb.append(StringUtils.transfDeal(orgName5)).append(separator);
	            sb.append(StringUtils.transfDeal(bondType)).append(separator);
	        	sb.append(StringUtils.transfDeal(agencyType5)).append(separator);
	        	sb.append(StringUtils.transfDeal(projectLeader5));
	        	sb.append(StringUtils.decode(linefeed));
        	}
        }
        return sb.toString();
