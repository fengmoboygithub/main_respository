	...
	<script src="${BASE_PATH}/static/manage/js/jquery.validate-1.0.0.js?v=${config_v}"></script>
	<script src="${BASE_PATH}/static/manage/js/jquery.paging-1.0.1.js?v=${config_v}"></script>
