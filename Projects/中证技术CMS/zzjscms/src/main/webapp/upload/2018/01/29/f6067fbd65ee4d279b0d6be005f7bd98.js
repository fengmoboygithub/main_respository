//interotc项目地址
	var interotc ="http://172.16.101.76";
//接口调用项目地址
	var interfacePath = "http://127.0.0.1/zzjsInterface/interface";
//项目路径地址
	var basePathMe = "/zzjscms";
/**
 * 封装公共接口调用js
 * Author : YangYanChao
 * Date: 2017/03/01
 ...
 */
function getNotPageListDataByBody(interUrl ,optionsParam, optionCallback, isAsync, isResubmit, $operable){
	   //筛选条件值
	   var defaultOptions = {};
 ...
 * @param isResubmit true为防止重复提交 false 为不处理
 */
function getNotPageListDataByParam(interUrl ,optionsParam, optionCallback, isAsync, isResubmit, $operable){
	   //筛选条件值
