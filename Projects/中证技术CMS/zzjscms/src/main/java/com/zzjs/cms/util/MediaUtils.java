...
public class MediaUtils {
	...
	public static void deleteFile(String path) {
		File file = new File(SystemConstant.ZZJS_CMS_ROOT + path);
		file.delete();
	}
	...
	public static String saveImage(MultipartFile multipartFile, int width,
		...
		String filePath = SystemConstant.ZZJS_CMS_ROOT + "/" + path;
		File file = new File(SystemConstant.ZZJS_CMS_ROOT + "/" + path);
	...
	public static void main(String[] args) {
		String ss = "sdfsdf.css";
		StringBuffer sb = new StringBuffer(MediaUtils.getFileExt(ss));
