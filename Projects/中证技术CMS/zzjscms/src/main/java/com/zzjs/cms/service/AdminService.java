...
import com.zzjs.cms.dao.AdminDao;
...
import com.zzjs.cms.util.AuthUtils;
...
public class AdminService {
	...
	public int deleteAdmin(long adminId) {
		adminSiteService.deleteAdminSiteByAdminId(adminId);
	 ...
	 * @return List<AdminVo>
	 */
	public List<AdminVo> getAllAdminList(long siteId) {
		List<AdminVo> allList =  this.getAllAdminList();
		for(AdminVo admin:allList){
			AdminSiteRelaVo adminSiteRelaVo = adminSiteService.getAdminSiteById(admin.getAdminId(), siteId);
