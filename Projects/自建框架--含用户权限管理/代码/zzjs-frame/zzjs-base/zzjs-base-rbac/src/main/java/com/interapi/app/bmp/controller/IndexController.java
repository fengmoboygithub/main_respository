...
public class IndexController {
    ...
    @Autowired
    private UserTabService<UserTab, UserTabExample> userTabService;
    
    @Autowired
    private UserTabMapper userTabMapper;
    
    @Autowired
    private RoleTabService<RoleTab, RoleTabExample> roleTabService;
    
    @Autowired
    private AuthorityTabService<AuthorityTab, AuthorityTabExample> authorityTabService;
    
    @Autowired
    private ResourceTabService<ResourceTab, ResourceTabExample> resourceTabService;
    
    @Autowired
    private PageTabService<PageTab, PageTabExample> pageTabService;
	
    @Secured("ROLE_Index_QUERY_USERINFO")
    ...
    @Secured("ROLE_Index_EDIT_USERINFO")
    ...
    @Secured("ROLE_Index_QUERY_MENUINFO")
    ...
    public ResponseDataListModel<PageTab> getMenuListByToken(String token) {
        ...
        try {
        	Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
        	String username = (String)authentication.getPrincipal();
        	List<PageTab> resultList = pageTabService.getPageTabListByUserId(username);
            responseModel.setSuccess(true);
    ...
    @Secured("ROLE_Index_QUERY_ROLELIST")
    ...
    @Secured("ROLE_Index_QUERY_AUTHORITYLIST")
    ...
    @Secured("ROLE_Index_QUERY_RESOURCELIST")
    ...
    @Secured("ROLE_Index_QUERY_PAGELIST")
