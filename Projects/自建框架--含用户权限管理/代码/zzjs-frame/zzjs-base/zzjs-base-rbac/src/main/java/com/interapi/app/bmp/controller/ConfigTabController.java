...
roleName = "配置_页面", roleFlag = "ROLE_ConfigTab_PAGE", homePage = "/pages/ConfigTab",
...
public class ConfigTabController {
    ...
    @Autowired
    private ConfigTabService<ConfigTab, ConfigTabExample> service;
	
	@Secured("ROLE_ConfigTab_QUERY_DETAIL")
    ...
    public ResponseDataModel<ConfigTab> get(Long id) {
        ...
        try {
            ConfigTab entity=service.get(id);
	...
	@Secured("ROLE_ConfigTab_QUERY_PAGE")
	//@Cacheable(value = "ConfigTab")
    ...
    @Secured("ROLE_ConfigTab_QUERY_LIST")
    //@Cacheable(value = "ConfigTab")
    ...
    public ResponseDataListModel<ConfigTab> getList(@RequestParam(required = false) String param)  throws BaseException{
    ...
    public ResponseDataModel<ConfigTab> add(@RequestBody ConfigTab model) {
        ResponseDataModel<ConfigTab> responseModel = new ResponseDataModel<ConfigTab>();
        try {
