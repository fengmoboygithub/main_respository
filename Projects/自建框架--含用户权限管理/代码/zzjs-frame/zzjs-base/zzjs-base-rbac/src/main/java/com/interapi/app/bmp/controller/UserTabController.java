...
roleName = "用户_页面", roleFlag = "ROLE_UserTab_PAGE", homePage = "/pages/UserTab",
...
public class UserTabController {
	...
	@Secured("ROLE_UserTab_QUERY_DETAIL")
//	@Cacheable(value = "UserTab")
    ...
    public ResponseDataModel<UserTab> get(Long id) {
        ...
        try {
            UserTab entity=service.selectUserDetailById(id);
	...
	@Secured("ROLE_UserTab_QUERY_PAGE")
//	@Cacheable(value = "UserTab")
    ...
    @Secured("ROLE_UserTab_QUERY_LIST")
//    @Cacheable(value = "UserTab")
    ...
    public ResponseDataListModel<UserTab> getList(@RequestParam(required = false) String param)  throws BaseException{
...
//	@CachePut(value = "UserTab", key = "#root.caches[0].name + ':' + #model.id")
    ...
    public ResponseDataModel<UserTab> add(@RequestBody UserTab model) {
...
//    @CachePut(value = "UserTab", key = "#root.caches[0].name + ':' + #model.id")
    @PutMapping(value = "/updatePassword", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    @ResourceMapping(code = "/api/UserTab/updatePassword", roleName = "用户_密码_编辑",
            roleFlag = "ROLE_UserTab_PASSWORD_EDIT")
    public ResponseModel updatePassword(@RequestBody UserTab model) {
        ResponseModel responseModel = new ResponseModel();
        try {
            UserTab record = new UserTab();
            BeanUtils.copyProperties(model, record);
            service.updatePassword(record);
        } catch (Exception e) {
            responseModel.setSuccess(false);
            responseModel.setMessage("Fail:" + e.getMessage());
            responseModel.setCode(HttpStatus.INTERNAL_SERVER_ERROR.value());
...
//    @CachePut(value = "UserTab", key = "#root.caches[0].name + ':' + #model.id")
    @PutMapping(value = "/initPassword", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    @ResourceMapping(code = "/api/UserTab/initPassword", roleName = "用户_密码_初始化",
            roleFlag = "ROLE_UserTab_PASSWORD_INIT")
    public ResponseModel initPassword(@RequestBody UserTab model) {
        ResponseModel responseModel = new ResponseModel();
        try {
            UserTab record = new UserTab();
            BeanUtils.copyProperties(model, record);
            service.initPassword(record);
        } catch (Exception e) {
            responseModel.setSuccess(false);
            responseModel.setMessage("Fail:" + e.getMessage());
            responseModel.setCode(HttpStatus.INTERNAL_SERVER_ERROR.value());
