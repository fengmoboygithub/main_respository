...
import com.interapi.app.bmp.model.RoleTabExample.Criteria;
...
@ResourceMapping(code = "RoleTab", name = "角色_模块", tableName = "role_tab", menuName = "基础信息管理",
roleName = "角色_页面", roleFlag = "ROLE_RoleTab_PAGE", homePage = "/pages/RoleTab",
...
public class RoleTabController {
    ...
    @Autowired
    private RoleTabService<RoleTab, RoleTabExample> service;
	
	@Secured("ROLE_RoleTab_QUERY_DETAIL")
	@Cacheable(value = "RoleTab")
    @PostMapping(value = "/get", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    @ResourceMapping(code = "/api/RoleTab/get", roleName = "角色_查询_详情", 
					roleFlag = "ROLE_RoleTab_QUERY_DETAIL")
    public ResponseDataModel<RoleTab> get(Long id) {
        ResponseDataModel<RoleTab> responseModel = new ResponseDataModel<>();
        try {
            RoleTab entity=service.get(id);
	...
	@Secured("ROLE_RoleTab_QUERY_PAGE")
	//@Cacheable(value = "RoleTab")
    @PostMapping(value = "/getListByPage", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    @ResponseBody
    @SuppressWarnings("unchecked")
    @ResourceMapping(code = "/api/RoleTab/getListByPage", roleName = "角色_查询_分页", 
					roleFlag = "ROLE_RoleTab_QUERY_PAGE")
    public ResponseDataPageListForBootModel<RoleTab> getListByPage(
        ...
        ResponseDataPageListForBootModel<RoleTab> responseModel = new ResponseDataPageListForBootModel<RoleTab>();
    ...
    @Secured("ROLE_RoleTab_QUERY_LIST")
    //@Cacheable(value = "RoleTab")
    @PostMapping(value = "/getList", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    @ResponseBody
    @SuppressWarnings("unchecked")
    @ResourceMapping(code = "/api/RoleTab/getList", roleName = "角色_查询_列表", 
					roleFlag = "ROLE_RoleTab_QUERY_LIST")
    public ResponseDataListModel<RoleTab> getList(@RequestParam(required = false) String param)  throws BaseException{
	...
	@Secured("ROLE_RoleTab_ADD")
	@CachePut(value = "RoleTab", key = "#root.caches[0].name + ':' + #model.id")
    @PostMapping(value = "/add", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    @ResourceMapping(code = "/api/RoleTab/add", roleName = "角色_添加", 
				roleFlag = "ROLE_RoleTab_ADD")
    public ResponseDataModel<RoleTab> add(@RequestBody RoleTab model) {
        ResponseDataModel<RoleTab> responseModel = new ResponseDataModel<RoleTab>();
        try {
	...
	@Secured("ROLE_RoleTab_EDIT")
	@CachePut(value = "RoleTab", key = "#root.caches[0].name + ':' + #model.id")
    @PutMapping(value = "/update", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    @ResourceMapping(code = "/api/RoleTab/update", roleName = "角色_编辑", 
			roleFlag = "ROLE_RoleTab_EDIT")
    public ResponseDataModel<RoleTab> update(@RequestBody RoleTab model) {
        ResponseDataModel<RoleTab> responseModel = new ResponseDataModel<RoleTab>();
        try {
            RoleTab record = new RoleTab();
            BeanUtils.copyProperties(model, record);
	...
	@Secured("ROLE_RoleTab_DELETE")
	@CacheEvict(value = "RoleTab")
    @DeleteMapping(value = "/del", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    @ResourceMapping(code = "/api/RoleTab/del", roleName = "角色_删除", 
				roleFlag = "ROLE_RoleTab_DELETE")
