...
import com.interapi.app.modular.model.RulesTabExample.Criteria;
...
@RestController("RulesTabController")
@RequestMapping("/api/RulesTab")
@ResourceMapping(code = "RulesTab", name = "验证规则_模块", tableName = "rules_tab", menuName = "模块管理",
roleName = "验证规则_页面", roleFlag = "ROLE_RulesTab_PAGE", homePage = "/pages/RulesTab",
pageSort = "6", menuSort = "1")
public class RulesTabController {

    public static Logger logger = LoggerFactory.getLogger(RulesTabController.class);

    @Autowired
    private RulesTabService<RulesTab, RulesTabExample> service;
	
	@Secured("ROLE_RulesTab_QUERY_DETAIL")
	@Cacheable(value = "RulesTab")
    @PostMapping(value = "/get", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    @ResourceMapping(code = "/api/RulesTab/get", roleName = "验证规则_查询_详情", 
					roleFlag = "ROLE_RulesTab_QUERY_DETAIL")
    public ResponseDataModel<RulesTab> get(Long id) {
        ResponseDataModel<RulesTab> responseModel = new ResponseDataModel<>();
        try {
            RulesTab entity=service.get(id);
	...
	@Secured("ROLE_RulesTab_QUERY_PAGE")
	//@Cacheable(value = "RulesTab")
    @PostMapping(value = "/getListByPage", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    @ResponseBody
    @SuppressWarnings("unchecked")
    @ResourceMapping(code = "/api/RulesTab/getListByPage", roleName = "验证规则_查询_分页", 
					roleFlag = "ROLE_RulesTab_QUERY_PAGE")
    public ResponseDataPageListForBootModel<RulesTab> getListByPage(
        ...
        ResponseDataPageListForBootModel<RulesTab> responseModel = new ResponseDataPageListForBootModel<RulesTab>();
        ...
        RulesTabExample example = new RulesTabExample();
        ...
        PageInfo<RulesTab> page = service.getListByPage(currentPage, itemsPerPage, example);
        responseModel.setSuccess(true);
    ...
    @Secured("ROLE_RulesTab_QUERY_LIST")
    //@Cacheable(value = "RulesTab")
    @PostMapping(value = "/getList", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    @ResponseBody
    @SuppressWarnings("unchecked")
    @ResourceMapping(code = "/api/RulesTab/getList", roleName = "验证规则_查询_列表", 
					roleFlag = "ROLE_RulesTab_QUERY_LIST")
    public ResponseDataListModel<RulesTab> getList(@RequestParam(required = false) String param)  throws BaseException{
        logger.info("param:{}", param);
        ResponseDataListModel<RulesTab> responseModel = new ResponseDataListModel<RulesTab>();
        HashMap<String, Object> paramMap = new HashMap<>();
        if (!StringUtils.isEmpty(param)) {
            try {
                paramMap = new ObjectMapper().readValue(param, HashMap.class);
        ...
        List<RulesTab> list = service.getList(example);
        responseModel.setSuccess(true);
	...
	@Secured("ROLE_RulesTab_ADD")
	@CachePut(value = "RulesTab", key = "#root.caches[0].name + ':' + #model.id")
    @PostMapping(value = "/add", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    @ResourceMapping(code = "/api/RulesTab/add", roleName = "验证规则_添加", 
				roleFlag = "ROLE_RulesTab_ADD")
    public ResponseDataModel<RulesTab> add(@RequestBody RulesTab model) {
        ResponseDataModel<RulesTab> responseModel = new ResponseDataModel<RulesTab>();
        try {
            RulesTab record = new RulesTab();
	...
	@Secured("ROLE_RulesTab_EDIT")
	@CachePut(value = "RulesTab", key = "#root.caches[0].name + ':' + #model.id")
    @PutMapping(value = "/update", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    @ResourceMapping(code = "/api/RulesTab/update", roleName = "验证规则_编辑", 
			roleFlag = "ROLE_RulesTab_EDIT")
    public ResponseDataModel<RulesTab> update(@RequestBody RulesTab model) {
        ResponseDataModel<RulesTab> responseModel = new ResponseDataModel<RulesTab>();
        try {
            RulesTab record = new RulesTab();
            BeanUtils.copyProperties(model, record);
	...
	@Secured("ROLE_RulesTab_DELETE")
	@CacheEvict(value = "RulesTab")
    @DeleteMapping(value = "/del", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    @ResourceMapping(code = "/api/RulesTab/del", roleName = "验证规则_删除", 
				roleFlag = "ROLE_RulesTab_DELETE")
