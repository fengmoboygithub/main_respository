...
* @date 2018-09-08
*/
package com.interapi.app.auth.model;
...
public class LoginUser implements UserDetails,Serializable {
     ...
     * 权限列表
     */
    private List<AuthorityTab> authorityList;
    /**
     * 最后重设密码时间
     */
//    private Date lastPasswordResetDate;
	...
	public List<AuthorityTab> getAuthorityList() {
		return authorityList;
	}

	public void setAuthorityList(List<AuthorityTab> authorityList) {
